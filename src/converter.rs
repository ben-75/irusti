...
pub fn i64_to_trits(value :i64) -> [i8;40]{
    ...
    if v < -225_141_952_945_498_681 { r[37] = -1; v += 450_283_905_890_997_363; }
    if v > 75_047_317_648_499_560 { r[36] = 1; v += -150_094_635_296_999_121; }
    if v < -75_047_317_648_499_560 { r[36] = -1; v += 150_094_635_296_999_121; }
    if v > 25_015_772_549_499_853 { r[35] = 1; v += -50_031_545_098_999_707; }
    if v < -25_015_772_549_499_853 { r[35] = -1; v += 50_031_545_098_999_707; }
    if v > 8_338_590_849_833_284 { r[34] = 1; v += -16_677_181_699_666_569; }
    if v < -8_338_590_849_833_284 { r[34] = -1; v += 16_677_181_699_666_569; }
    if v > 2_779_530_283_277_761 { r[33] = 1; v += -5_559_060_566_555_523; }
    if v < -2_779_530_283_277_761 { r[33] = -1; v += 5_559_060_566_555_523; }
    if v > 926_510_094_425_920 { r[32] = 1; v += -1_853_020_188_851_841; }
    if v < -926_510_094_425_920 { r[32] = -1; v += 1_853_020_188_851_841; }
    if v > 308_836_698_141_973 { r[31] = 1; v += -617_673_396_283_947; }
    if v < -308_836_698_141_973 { r[31] = -1; v += 617_673_396_283_947; }
    if v > 102_945_566_047_324 { r[30] = 1; v += -205_891_132_094_649; }
    if v < -102_945_566_047_324 { r[30] = -1; v += 205_891_132_094_649; }
    if v > 34_315_188_682_441 { r[29] = 1; v += -68_630_377_364_883; }
    if v < -34_315_188_682_441 { r[29] = -1; v += 68_630_377_364_883; }
    if v > 11_438_396_227_480 { r[28] = 1; v += -22_876_792_454_961; }
    if v < -11_438_396_227_480 { r[28] = -1; v += 22_876_792_454_961; }
    if v > 3_812_798_742_493 { r[27] = 1; v += -7_625_597_484_987; }
    if v < -3_812_798_742_493 { r[27] = -1; v += 7_625_597_484_987; }
    if v > 1_270_932_914_164 { r[26] = 1; v += -2_541_865_828_329; }
    if v < -1_270_932_914_164 { r[26] = -1; v += 2_541_865_828_329; }
    if v > 423_644_304_721 { r[25] = 1; v += -847_288_609_443; }
    if v < -423_644_304_721 { r[25] = -1; v += 847_288_609_443; }
    if v > 141_214_768_240 { r[24] = 1; v += -282_429_536_481; }
    if v < -141_214_768_240 { r[24] = -1; v += 282_429_536_481; }
    if v > 47_071_589_413 { r[23] = 1; v += -94_143_178_827; }
    if v < -47_071_589_413 { r[23] = -1; v += 94_143_178_827; }
    if v > 15_690_529_804 { r[22] = 1; v += -31_381_059_609; }
    if v < -15_690_529_804 { r[22] = -1; v += 31_381_059_609; }
    if v > 5_230_176_601 { r[21] = 1; v += -10_460_353_203; }
    if v < -5_230_176_601 { r[21] = -1; v += 10_460_353_203; }
    if v > 1_743_392_200 { r[20] = 1; v += -3_486_784_401; }
    if v < -1_743_392_200 { r[20] = -1; v += 3_486_784_401; }
    if v > 581_130_733 { r[19] = 1; v += -1_162_261_467; }
    if v < -581_130_733 { r[19] = -1; v += 1_162_261_467; }
    if v > 193_710_244 { r[18] = 1; v += -387_420_489; }
    if v < -193_710_244 { r[18] = -1; v += 387_420_489; }
    if v > 64_570_081 { r[17] = 1; v += -129_140_163; }
    if v < -64_570_081 { r[17] = -1; v += 129_140_163; }
    if v > 21_523_360 { r[16] = 1; v += -43_046_721; }
    if v < -21_523_360 { r[16] = -1; v += 43_046_721; }
    if v > 7_174_453 { r[15] = 1; v += -14_348_907; }
    if v < -7_174_453 { r[15] = -1; v += 14_348_907; }
    if v > 2_391_484 { r[14] = 1; v += -4_782_969; }
    if v < -2_391_484 { r[14] = -1; v += 4_782_969; }
    if v > 797_161 { r[13] = 1; v += -1_594_323; }
    if v < -797_161 { r[13] = -1; v += 1_594_323; }
    if v > 265_720 { r[12] = 1; v += -531_441; }
    if v < -265_720 { r[12] = -1; v += 531_441; }
    if v > 88_573 { r[11] = 1; v += -177_147; }
    if v < -88_573 { r[11] = -1; v += 177_147; }
    if v > 29_524 { r[10] = 1; v += -59_049; }
    if v < -29_524 { r[10] = -1; v += 59_049; }
    if v > 9_841 { r[9] = 1; v += -19_683; }
    if v < -9_841 { r[9] = -1; v += 19_683; }
    if v > 3_280 { r[8] = 1; v += -6_561; }
    if v < -3_280 { r[8] = -1; v += 6_561; }
    if v > 1_093 { r[7] = 1; v += -2_187; }
    if v < -1_093 { r[7] = -1; v += 2_187; }
